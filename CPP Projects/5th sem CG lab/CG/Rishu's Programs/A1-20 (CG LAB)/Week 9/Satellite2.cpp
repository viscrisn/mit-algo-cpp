...
circle(100,0,0);
int temp1=sat.x,temp2=sat.y;
translate(-temp1,-temp2,&sat,1);
rotate(i,&sat,1);
translate(temp1,temp2,&sat,1);
rotate(i,&sat,1);
circle(20,sat.x,sat.y);

translate(-temp1,-temp2,l1,2);
rotate(i,l1,2);
translate(temp1,temp2,l1,2);
rotate(i,l1,2);
